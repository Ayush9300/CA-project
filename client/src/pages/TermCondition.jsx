...
const TermCondition = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      {/* Main Content */}
      <div className="max-w-4xl mx-auto p-8 pt-16 space-y-8 text-gray-700">
        ...
        <div className="space-y-4">
          <p>
            Welcome to <span className="font-semibold">EBIZ</span>. These Terms &
        ...
        <div>
          ...
          <p>
            TaxBixLegal is a professional services provider offering legal, tax,
            and compliance-related services including but not limited to:
          </p>
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Legal and financial advisory related to startups and businesses
            </li>
          </ul>
          <p className="mt-2">
            We are not a law firm or a chartered accountancy firm but work in
            collaboration with licensed professionals and consultants.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            TaxBixLegal assists in the preparation, filing, and submission of
            various legal and tax documents. However:
          </p>
          <ul className="list-disc list-inside space-y-1">
            <li>
              We do not represent clients in court or before government
              authorities unless explicitly stated
            </li>
            <li>
              Our services are subject to the availability of required information
              and cooperation from the client
            </li>
            <li>
              Timelines provided are indicative and may vary based on external
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              All payments for services are to be made in advance unless otherwise
              agreed
            </li>
            <li>
              Fees once paid are non-refundable, except under exceptional
              circumstances and at our sole discretion
            </li>
            <li>
              In case of any service delay or issues, you may contact our support
              team for resolution
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            and software is the property of TaxBixLegal and protected by
            applicable intellectual property laws. You may not reproduce, copy,
            or exploit any part of the site without our written permission.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            While we strive for accuracy and timely service, TaxBixLegal shall
            not be held liable for:
          </p>
          <ul className="list-disc list-inside space-y-1">
            <li>
              Any loss or damage arising due to reliance on information provided
              by us
            </li>
            <li>
              Delays or non-performance due to third-party or government-related
              issues
            </li>
            <li>
              Errors caused by incomplete or incorrect information provided by you
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            not endorse or take responsibility for the content, terms, or privacy
        ...
        <div>
          ...
          <p>
            ...
            be posted on this page with the revised “Effective Date.” Continued
        ...
        <div>
          ...
          <ul className="list-none space-y-1">
            <li>
              Email:{" "}
              <a
                href="mailto:info@EbizPanjiyancom"
                className="text-blue-600 hover:underline"
              >
                info@EbizPanjiyancom
              </a>
            </li>
            <li>
              Phone:{" "}
              <a
                href="tel:+919403892279"
                className="text-blue-600 hover:underline"
              >
                9403892279
              </a>
            ...
            <li>
              Address: Sai Shivalik Complex, Jagannathpur, Bamunari,
              Hooghly-712250, West Bengal
            </li>
          </ul>
        </div>
      </div>
